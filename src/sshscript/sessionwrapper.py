...
class SessionWrapper(object):
    ...
    def su(self,username,password=None,expect=None,initials=None,command=None,login=True,get_pty=None):
    ...
    def sudo(self,password=None,expect=None,initials=None,command=None,login=True,username=None,get_pty=None):
    ...
    def __exit__(self,*args):
        ## added on 2026/3/2
        #self.console_wrapper.__exit__(*args)
