...
| [Example Gallery]({{ site.baseurl }}/v3a/Example%20Gallery/) | Reserved for tested, safety-labelled operational recipes. |
...
Pages marked **Placeholder** are deliberately visible so missing coverage is
not mistaken for finished documentation. English is the maintained navigation
language for this phase; existing translated files are retained in source but
excluded from the published site and sidebar.

> **Version notice:** v3.1 is beta source and is not currently published on
> PyPI. Begin with
