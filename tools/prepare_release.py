...
TESTS = [
    ...
    'test_logger_api.py', 'test_logger_integration.py',
    'test_openssh_integration.py', 'test_production_contract.py',
    'test_session_close_reporting.py', 'test_session_proxy_cleanup.py',
    'test_spy_source_mapping.py', 'test_spy_thread_session.py',
    'test_ssh_security.py', 'test_sshscript_dollar_syntax.py',
    'test_sshscript_module.py', 'test_stdio_dynamic_string.py',
    'test_syntax_error.spy', 'test_update_check.py',
]
